========================================================================
    KONSOLENANWENDUNG: Filesizeteller-Projektübersicht
========================================================================

Diese Filesizeteller-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Filesizeteller-Anwendung besteht.


Filesizeteller.vcxproj
...
Filesizeteller.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Filesizeteller.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
